...
<body>
  <div class="layout">
    ...
    <div class="layout-header am-hide-sm-only">
      <!--topbar start-->
      <div class="topbar" style="background-color:#ff8000">
        <div class="container">
          <div class="am-g">
            <div class="am-u-md-3">
              <div class="topbar-left">
                <i class="am-icon-globe"></i>
                <div class="am-dropdown" data-am-dropdown style="color:#ff8000">
                  <button class="am-btn am-btn-primary am-dropdown-toggle" data-am-dropdown-toggle style="background-color:#ff8000;border:0">Language <span class="am-icon-caret-down"></span></button>
            ...
            <div class="header">
              <div class="am-g">
                <div class="am-u-lg-2 am-u-sm-12">
                  <div class="logo">
                    <a href="" style="color:#ff8000;font-size:25px">金好美</a>
                  </div>
                </div>
                    ...
                    <div class="header-contact">
                      <div class="header_contacts--item">
  											<div class="contact_mini">
  												<i style="color:#ff8000" class="contact-icon am-icon-phone"></i>
                      ...
                      <div class="header_contacts--item">
  											<div class="contact_mini">
  												<i style="color:#ff8000" class="contact-icon am-icon-envelope-o"></i>
                      ...
                      <div class="header_contacts--item">
  											<div class="contact_mini">
  												<i style="color:#ff8000" class="contact-icon am-icon-map-marker"></i>
  												<strong>天使大厦,</strong>
  												<span>海淀区海淀大街27</span>
  											</div>
  										</div>
                  ...
                  <div class="container">
                    <div class="am-g">
                      <div class="am-u-md-10 am-u-sm-centered">
                        <h3 class="slide_simple--title">国字品牌金耀湖湘,国民珠宝全民共赏</h3>
                        <p class="slide_simple--text am-text-left">
												  金好美文化公司主营业务为贵金属工艺品、珠宝首饰的研发设计、生产及销售,已逐步打造成一家优秀的平台型企业。
											  </p>
          ...
          <ul class="am-tabs-nav am-cf index-tab">
            <li class="am-active">
              <a href="[data-tab-panel-0] am-g">
                <div class="am-u-md-3 am-u-sm-3 am-padding-right-0">
                  <i class="am-icon-cog"style="color:#ff8000"></i>
                </div>
            ...
            <li class="a">
              <a href="[data-tab-panel-1] am-g">
                <div class="am-u-md-3 am-u-sm-3 am-padding-right-0">
                  <i class="am-icon-lightbulb-o"style="color:#ff8000"></i>
                </div>
                <div class="school-item-right am-u-md-9 am-u-sm-9 am-text-left">
            ...
            <li class="">
              <a href="[data-tab-panel-2] am-g">
                <div class="am-u-md-3 am-u-sm-3 am-padding-right-0">
                  <i class="am-icon-line-chart"style="color:#ff8000"></i>
                </div>
                <div class="school-item-right am-u-md-9 am-u-sm-9 am-text-left">
            ...
            <li class="">
              <a href="[data-tab-panel-3] am-g">
                <div class="am-u-md-3 am-u-sm-3 am-padding-right-0">
                  <i class="am-icon-hourglass-end"style="color:#ff8000"></i>
                </div>
                <div class="school-item-right am-u-md-9 am-u-sm-9 am-text-left">
